...
<xsl:stylesheet
    ...
    <xsl:template name="openscad_header" >
        <xsl:text>// This file is automatically generated with https://github.com/jbenf/inkextrude
  ...
  <xsl:template match="svg:svg" mode="openscad_main">
    <xsl:call-template name="block">
      ...
      <xsl:with-param name="content">
        <xsl:call-template name="block">
          <xsl:with-param name="header" select="string('intersection()')" />
          <xsl:with-param name="content">
            <xsl:call-template name="block">
              ...
              <xsl:with-param name="content">
                <xsl:call-template name="block">
                  ...
                  <xsl:with-param name="content">
                    <xsl:apply-templates select="(svg:g|svg:ellipse|svg:rect|svg:path)[not(contains(@inkscape:label, 'diff=true')) and contains(@inkscape:label, 'height=') and not(contains(@inkscape:label, 'intersect=true'))]" mode="openscad_main" />
                  </xsl:with-param>
                </xsl:call-template>
                <xsl:text>&#xa;</xsl:text>
                <xsl:call-template name="block">
            ...
            <xsl:text>&#xa;</xsl:text>
            <xsl:apply-templates select="(svg:g|svg:ellipse|svg:rect|svg:path)[contains(@inkscape:label, 'intersect=true') and contains(@inkscape:label, 'height=')]" mode="openscad_main" />
          </xsl:with-param>
        </xsl:call-template>
      </xsl:with-param>
    </xsl:call-template>
